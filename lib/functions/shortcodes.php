...
add_shortcode('lamp_sns', 'lamp_sc_social_buttons');
function lamp_sc_social_buttons(){
...
add_shortcode('lamp_dir', 'lamp_sc_template_directory');
function lamp_sc_template_directory(){
...
add_shortcode('sitemap', 'lamp_simple_sitemap');
function lamp_simple_sitemap(){
  global $wpdb;
